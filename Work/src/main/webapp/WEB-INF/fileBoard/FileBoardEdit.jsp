...
<div class="browser">
    <div class="table-style table-body-style">
        <div class="table-column table-column-number"><input class="input-box-style" id="title" type="text" placeholder="Input Title" maxlength="30" value="${boardRecord.title}"></div>
    ...
    <div contenteditable="true" id="contentEditable" class="editor-style textarea-style" spellcheck="false">${boardRecord.content}</div>
</div>
<div class="paging-style">
	<form action="/fileBoardList" method="post" onsubmit="return writeValidate();" enctype="multipart/form-data">
		...
		<input type="hidden" value="${boardRecord.fno}" name="fno"></input>
