...
<div class="pop-up-layout-reset">
    <div class="reset-3d-card">
        <div class="reset-message">Are you sure you want to reset it?</div>
...
<div class="browser">
    <div class="table-style table-body-style">
        <div class="table-column table-column-number"><input class="input-box-style" id="title" type="text" placeholder="Input Title" value="${boardRecord.title}" maxlength="30"></div>
    ...
    <div contenteditable="true" id="contentEditable" class="editor-style textarea-style" spellcheck="false"><div>${boardRecord.content}</</div></div>
</div>
<div class="paging-style">
	<form action="/view" method="post" onsubmit="return writeValidate();">
    	<button class="button-box-style" name="SubmitBoardList" value="update">수정</button>
    	<input type="hidden" value="${boardRecord.title}" id="titleParameter" name="titleParameter"></input>
		<input type="hidden" id="contentParameter" name="contentParameter"></input>
        <input type="hidden" value="${boardRecord.bno}" name="bno"></input>
        <input type="hidden" value="${nowPage}" name="nowPage"></input>
    ...
    <button class="button-box-style" name="out"><a href="javascript:history.back();">나가기</a></button>
</div>
